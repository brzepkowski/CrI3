...
def HoneyComb_lattice_model(lattice, Jx, Jy, Jz, D, hx=0., hy=0., hz=0., muJ=0., E=0., bcx="open", bcy="cylinder"):

    model_params = {
        # "S": 1.5,  # Spin 3/2
        # "lattice": "Honeycomb",
        "lattice": lattice,
        "bc_MPS": "finite", # Combined with bcx='periodic' and bcy='ladder' it gives a finite cylindrical system.
        "bc_y": bcy,
        "bc_x": bcx,
...
if __name__ == "__main__":
    ...
    model = HoneyComb_lattice_model(lattice=lattice, Jx=-J, Jy=-J, Jz=-J-L, D=-D, bcx="open", bcy="cylinder")
