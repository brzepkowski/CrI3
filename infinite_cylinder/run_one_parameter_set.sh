...
NAME=`echo "inf_cylinder_DMRG_${Lx}_${Ly}_${D}_${J}_${L}_${Sz}"`
...
#PBS -m n\n\
cd \$PBS_O_WORKDIR\n\
python3 -W ignore ../one_sector_dmrg.py $Lx $Ly $D $J $L $Sz $finished_params_filename >& inf_cylinder_DMRG_${Lx}_${Ly}_${D}_${J}_${L}_${Sz}.txt"
